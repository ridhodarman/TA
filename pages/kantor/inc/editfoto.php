                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align: center;">
                    ...
                    $sql = pg_query("SELECT photo_url, upload_date FROM office_building_gallery WHERE office_building_id='$id' 
                        ...
                        while ($row = pg_fetch_assoc($sql)) {
                            ...
                            echo "</tr>";
                            // echo '
                            //     <div class="modal fade" id="delete-foto'.$id2.'">
                            //         <div class="modal-dialog">
                            //             <div class="modal-content">
                            //                 <div class="modal-header">
                            //                     <h5 class="modal-title">Delete Photo ?</h5>
                            //                     <button type="button" class="close" onclick="tutup('."'".$id2."'".')"><span>&times;</span></button>
                            //                 </div>
                            //                 <div class="modal-body">
                            //                     <p>Are you sure to delete this photo ?</p>
                            //                 </div>
                            //                 <div class="modal-footer">
                            //                     <button type="button" class="btn btn-secondary" onclick="tutup('."'".$id2."'".')">Cancel</button>
                            //                     <a href="act/info-hapusfoto.php?id-bang='.$id.'&&id-foto='.$id2.'"><button type="button" class="btn btn-danger">Delete</button></a>
                            //                 </div>
                            //             </div>
                            //         </div>
                            //     </div>
...
<script type="text/javascript">
    // function tutup (pop_up) {
    //     $("#delete-foto"+pop_up).modal('hide');
    // }

...
<button class="btn btn-default btn-lg" style="width: 90%; background-color: #fafafa" data-toggle="modal" data-target="#tambahfasilitas">+
    Add Office Facility Data</button>
</div>
        ...
        <form method="post" id="form-tambahfas" style="width: 90%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Office Facility Data</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
                    <p>Name of Office Facilities:</p>
                    <input type="text" class="form-control" name="fasilitas" id="fasilitas" placeholder="Enter the name of the office facility...">
                </div>
...
<div class="panel-body" style="padding-top: 2%; padding-left: 2%; padding-right: 2%" id="tabel-fasilitas">
    <h4 style="text-align: center;">List of Office Facilities</h4>
            ...
            <tbody>
                <?php
                    ...
                    while ($data=pg_fetch_assoc($sql)) {
                        ...
                        $fas_k=pg_num_rows(pg_query("SELECT office_building_id FROM detail_office_building_facilities WHERE facility_id='$id'"));
                        	...
                        	<div class="modal fade" id="deletefas-'.$id.'">
    						    <div class="modal-dialog">
    						        <div class="modal-content">
    						            ...
    						            <div class="modal-body">
    						                <p>Are you sure to delete "'.$fas.'" from  the office facility data ? <br/>
    						                There are as many as <b> '.$fas_k.' </b> office building(s) that have this facility.
    						                </p>
    						            </div>
    						            <div class="modal-footer">

...
<button class="btn btn-default btn-lg" style="width: 90%; background-color: #fafafa" data-toggle="modal" data-target="#tambahjenis">+
    Add Office Building Type </button>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Office Building Type</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <form method="post" id="form-tambahjenis">
                <div class="modal-body">
                    <p>Office Building Type:</p>
                    <input type="text" class="form-control" name="jenis" id="jenis" placeholder="Enter the type of office building..." value="">
                </div>
...
<div class="panel-body" style="padding-top: 2%; padding-left: 2%; padding-right: 2%" id="tabel-jenis-kantor">
    <h4 style="text-align: center;">List of Office Building Type</h4>
   
        <table width="100%" class="table table-striped table-bordered table-hover" id="listjenis">
            <thead>
                <tr style="text-align: center">
                    <th>No.</th>
                    <th>Types of Office Building</th>
                    <th>Action</th>
                </tr>
            </thead>
            <tbody>
                <?php
                    $sql=pg_query("SELECT type_id, name_of_type FROM type_of_office ORDER BY name_of_type ASC");
                    $no=1;
                        	...
                        	<div class="modal fade" id="delete-j'.$id.'">
    						    <div class="modal-dialog">
    						        <div class="modal-content">
    						            ...
    						            <div class="modal-body">
                                            <p>Are you sure to delete "'.$jenis.'" from the type of office ? <br/>
                                            There are as many as <b>'.$k.'</b> office building(s) that have this type.
                                            </p>
    						            </div>
    						            <div class="modal-footer">
        ...
        $("#tambahkanj").click(function(){ 
            ...
            if (jenis==null || jenis=='') {
                ...
                $.ajax({
                    ...
                    data: data,
                    success: function() {
                        $('#tabel-jenis-kantor').load("inc/load-jenis.php");

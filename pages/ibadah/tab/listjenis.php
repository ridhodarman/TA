...
<button class="btn btn-default btn-lg" style="width: 90%; background-color: #fafafa" data-toggle="modal" data-target="#tambahjenis">+
    Add Worship Building Type </button>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Worship Building Type</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <form method="post" id="form-tambahjenis">
                <div class="modal-body">
                    <p>Worship Building Type:</p>
                    <input type="text" class="form-control" name="jenis" id="jenis" placeholder="Enter the type of whrship building...">
                </div>

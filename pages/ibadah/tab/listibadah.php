...
<button class="btn btn-default btn-lg" style="width: 90%; background-color: #fafafa" onclick="load()" data-toggle="modal" data-target="#tambahibadah">+
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="hide3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6" id="jenisibadah">
...
<script type="text/javascript">
    ...
    function load() {
        $('#jenisibadah').load("inc/combobox-jenisibadah.php");
    }
</script>
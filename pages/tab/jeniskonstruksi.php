                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-danger" onclick="hapusjenis('.$id.')">Delete</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="modal fade" id="sukses-tambah">
    <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <center>
...
<div class="modal fade" id="sukses-update">
    <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <center>
...
<div class="modal fade" id="datakosong">
    <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <center>
                        <div>
                            ...
                            <p>Input data cannot be empty !</p>
                        </div>

...
<button class="btn btn-default btn-lg" style="width: 90%; background-color: #fafafa" data-toggle="modal" data-target="#tambahpendidikan">+
        ...
        <form method="post" id="form-tambahjenis" style="width: 90%;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" name="jenis" id="jenis" placeholder="enter the name of the education level...">
                </div>
            ...
            <tbody  id="tabel-jenis-umkm">
                <?php
                    ...
                    while ($data=pg_fetch_assoc($sql)) {
                        ...
                        echo "<td>".$jenis."</td>";
                        echo '<td>
                            <button class="btn btn-info btn-xs" data-toggle="modal" data-target="#edit-p'.$id.'"><i class="fa fa-edit"></i> Edit</button>
                            <button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-p'.$id.'"><i class="fa fa-trash"></i> Delete</button>
                            </td>';
                        echo "</tr>";
                        	...
                        	<div class="modal fade" id="delete-p'.$id.'">
    						    <div class="modal-dialog">
    						        <div class="modal-content">
    						            ...
    						            <div class="modal-body">
    						                <p>Are you sure to delete "'.$jenis.'" from the type of education level ? <br/>
    						                There are as many as <b>100</b> head(s) of family that have this education type.
    						                </p>
    						            </div>
    						            <div class="modal-footer">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <form method="post" id="form-editjenis">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Type of Education Level:</p>
                                                <input type="text" class="form-control" name="e-jenis" id="jenis" placeholder="enter the name of the education level..." value="'.$jenis.'">
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>

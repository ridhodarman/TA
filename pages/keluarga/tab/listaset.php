        ...
        <form method="post" id="form-tambahjenis" style="width: 90%;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Asset Name:</p>
                    <input type="text" class="form-control" name="jenis" id="jenis" placeholder="enter asset name...">
                </div>
            ...
            <tbody  id="tabel-jenis-umkm">
                <?php
                    ...
                    while ($data=pg_fetch_assoc($sql)) {
                        ...
                        echo "<td>".$jenis."</td>";
                        echo '<td>
                            <button class="btn btn-info btn-xs" data-toggle="modal" data-target="#edit-a'.$id.'"><i class="fa fa-edit"></i> Edit</button>
                            <button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-a'.$id.'"><i class="fa fa-trash"></i> Delete</button>
                            </td>';
                        echo "</tr>";
                        	...
                        	<div class="modal fade" id="delete-a'.$id.'">
    						    <div class="modal-dialog">
    						        <div class="modal-content">
    						            ...
    						            <div class="modal-body">
    						                <p>Are you sure to delete "'.$jenis.'" from the asset list? <br/>
    						                There are as many as <b>100</b> head(s) of family(ies) who own this asset.
    						                </p>
    						            </div>
    						            <div class="modal-footer">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <form method="post" id="form-editjenis">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Asset Name:</p>
                                                <input type="text" class="form-control" name="e-jenis" id="jenis" placeholder="enter asset name..." value="'.$jenis.'">
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>

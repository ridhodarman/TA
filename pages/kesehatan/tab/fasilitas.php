...
<button class="btn btn-default btn-lg" style="width: 90%; background-color: #fafafa" data-toggle="modal" data-target="#tambahfasilitas">+
    Add Health Facility Data</button>
</div>

<div class="modal fade" id="tambahfasilitas">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form method="post" id="form-tambahfas" style="width: 90%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Health Facility Data</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <div class="modal-body">
                    <p>Name of Health Facilities:</p>
                    <input type="text" class="form-control" name="fasilitas" id="fasilitas" placeholder="Enter the name of the health facility...">
                </div>
...
<div class="panel-body" style="padding-top: 2%; padding-left: 2%; padding-right: 2%" id="tabel-fasilitas">
    <h4 style="text-align: center;">List of Health Facilities</h4>
            ...
            <tbody>
                <?php
                    ...
                    while ($data=pg_fetch_assoc($sql)) {
                        ...
                        $fas_k=pg_num_rows(pg_query("SELECT health_building_id FROM detail_health_building_facilities WHERE facility_id='$id'"));
                        	...
                        	<div class="modal fade" id="deletefas-'.$id.'">
    						    <div class="modal-dialog">
    						        <div class="modal-content">
    						            ...
    						            <div class="modal-body">
    						                <p>Are you sure to delete "'.$fas.'" from  the health facility data ? <br/>
    						                There are as many as <b> '.$fas_k.' </b> health building(s) that have this facility.
    						                </p>
    						            </div>
    						            <div class="modal-footer">
                                ...
                                <form method="post" id="form-editfas">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="text" class="form-control" name="fas-edit" id="fas-edit'.$id.'" placeholder="Enter the name of the health facility..." value="'.$fas.'">
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>

                            ...
                            <div class="col-sm-6" id="hide3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="medis" value="0" onkeypress="return hanyaAngka(event, '#mediss')">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label>Number of Non-Medical Personnel</label><label id="nons"></label>
                                        <input type="text" class="form-control" name="non" value="0" onkeypress="return hanyaAngka(event, '#nons')">
                                    </div>
                                    <div class="form-group col-sm-6">

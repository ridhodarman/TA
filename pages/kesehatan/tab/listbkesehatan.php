...
<button class="btn btn-default btn-lg" style="width: 90%; background-color: #fafafa" onclick="load()" data-toggle="modal" data-target="#tambahbang">+
    Add Health Building Data </button>
</div>

<div class="panel-body" style="padding-top: 2%; padding-left: 2%; padding-right: 2%">
    <h4 style="text-align: center;">List of Health Buildings</h4>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Are you sure to delete "'.$nama.'" from  the health building data ?</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                        <a href="act/hapus-b-kesehatan.php?id='.$id2.'"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<div class="modal fade bd-example-modal-lg modal-xl" id="tambahbang">
        <div class="modal-dialog modal-lg modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Health Building Data</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                </div>
                <form role="form" action="act/tambah-b-kesehatan.php" enctype="multipart/form-data" method="post">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="hide3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="medis" value="" onkeypress="return hanyaAngka(event, '#mediss')">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label>Number of Non-Medical Personnel</label><label id="nons"></label>
                                        <input type="text" class="form-control" name="non" value="" onkeypress="return hanyaAngka(event, '#nons')">
                                    </div>
                                    <div class="form-group col-sm-6">
...
<script type="text/javascript">
    ...
    function cekid () {
        ...
        var ketemu=false;
        <?php 
          $sql = pg_query("SELECT health_building_id FROM health_building");
    ...
    function load() {
        $('#jeniskesehatan').load("inc/combobox-jenis.php");
    }
</script>
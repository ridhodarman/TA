...
<head>
    ...
    <?php include('inc/headpages_awal.php') ?>
</head>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="konstruksi-tab" data-toggle="tab" href="#konstruksi" role="tab" aria-controls="konstruksi" aria-selected="false"><i class="fa fa-legal"></i> Manage Data on Types of Construction</a>
                            </li>
                        </ul>

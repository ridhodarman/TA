                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          ...
                          <!--   <li class="nav-item">
                                <a class="nav-link" id="profile-jenis" data-toggle="tab" href="#jenis" role="tab" aria-controls="jenis" aria-selected="false"><i class="fas fa-radiation"></i> Type</a>
                            </li> -->
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false"><i class="fas fa-cubes"></i> Manage Educational Facilities Data</a>
                            </li>
                        </ul>
                        <div class="tab-content mt-3" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <?php include ("tab/listbpendidikan.php") ?>
                            </div>
